...
var placemarks = [
{
    ...
    hintContent: '<div class="map__hint"><img class="map__burger-img" src="../img/src/map/map_logo2.png" alt="Resident"/><div class="map_text">Apartments fo rent<br>st. Krylova, 64/1</div></div>',
    balloonContent: [
    '<div align="center" class="map__balloon">',
    '<img class="map__burger-img" src="../img/src/map/map_logo2.png" alt="Resident"/>',
    '<br>Apartments fo rent<br>st. Krylova, 64/1',
    '</div>'
    ],
},
],
